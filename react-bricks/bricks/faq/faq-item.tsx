...
const FaqQuestion: types.Brick<FaqQuestionProps> = ({ id, question, answer }) => {
  ...
  return (
    <div className="leading-6">
      <Text
        ...
        value={question}
        renderBlock={(props) => (
          <h3 {...idAttribute} {...props.attributes} className="group relative mb-1">
            {id && (
              <a
                href={`#${id}`}
                className="absolute left-0 top-1/2 flex -translate-x-full -translate-y-1/2 pr-2 opacity-0 transition-opacity duration-200 ease-out group-hover:opacity-100"
              >
                <svg
                  viewBox="0 0 1024 1024"
                  width="18px"
                  height="18px"
                  className="fill-gray-400 transition-colors duration-200 ease-out hover:fill-gray-500"
                >
      ...
      <RichText
        ...
        value={answer}
        renderBlock={(props) => (
          <p {...props.attributes} className="mt-0">
            {props.children}
          </p>
        )}
        placeholder="Answer..."
